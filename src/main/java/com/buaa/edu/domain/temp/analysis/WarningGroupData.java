...
public class WarningGroupData {
    ...
    public ArrayList<WarningFormatData> getWarn_data_list() {
        return warn_data_list;
    }
    ...
    public String[] GetTimes() {
        start_time = this.warn_data_list.get(0).happen_time;
        MyTime endTime = this.warn_data_list.get(warn_data_list.size() - 1).happen_time;

        String[] strs = new String[2];
        strs[0] = start_time.toString();
        strs[1] = endTime.toString();
        return strs;
    ...
    public void FindAlertPlace(String handle_process) {
            ...
            if (data.err_signal.string_type.equals("MUT_LOS")) {
                ...
                if (last_level == -1 || last_port_name == null) {
                    ...
                    if (this_level - last_level == 1) {
                        this.lastLabel = last_port_name;
                        this.nextLabel = this_port_name;
                        this.lastLevel = last_level;
                        this.nextLevel = this_level;
                        this.findAlert = true;
                    } else {
                        last_level = this_level;
                        last_port_name = this_port_name;
    ...
    public String getWarning_on_route() {
        return warning_on_route;
    }
}
